// components/EmployeeForgotPassword.jsx
...
function EmployeeForgotPassword() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            console.log('Sending request to:', `${API_URL}/api/employee/forgot-password`)
            const res = await fetch(`${API_URL}/api/employee/forgot-password`, {
                method: "POST",
