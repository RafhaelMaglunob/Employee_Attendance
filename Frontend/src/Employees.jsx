...
import { Filter, Search } from './component/ui/search'
...
function Employees() {
    ...
    return (
        <>  
            ...
            <Card header={headerContent} radius="none" variant="admin" width="full" className="">
                ...
                <div className="mt-5">
                    ...
                    <div className="border-t mt-5 pt-2 flex flex-row justify-between">
                        <p>Showing {filteredData.length } to {data.length} of {data.length} entries</p>
                        <div className="flex flex-row space-x-1">
                            <Button className="bg-black text-white rounded-md px-4 py-1 text-sm">Previous</Button>
                            <Button className="bg-black/60 text-white rounded-md px-4 py-1 text-sm">1</Button>
                            <Button className="bg-black text-white rounded-md px-4 py-1 text-sm">Next</Button>
                        </div>
                    </div>
                </div>
            </Card>
