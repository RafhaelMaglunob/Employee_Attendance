...
function Salary() {
    ...
    const handleView = (row) => setSelectedEmployee({ employee_id: row.employee_id, name: row.name });
    ...
    if (loading) return <p className="text-lg font-bold">Loading...</p>;
        ...
        <div>
            ...
            <div className="flex justify-between items-center mb-3 mt-3 mr-3">
                ...
                <div className="flex space-x-3">
                    <Button className="bg-white px-2 py-1 rounded-xl border hover:bg-black/10 flex items-center">
                    ...
                    <Button 
                        ...
                        className="bg-black text-white px-2 py-1 rounded-xl flex items-center hover:bg-black/70"
                    >
